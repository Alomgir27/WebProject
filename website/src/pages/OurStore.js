...
const OurStore = () => {
  ...
  useEffect(() => {
    if(price.pricelow === ""){
      setPrice({...price, pricelow: 0});
    }
    if(price.pricehigh === ""){
      setPrice({...price, pricehigh: 100000});
    }
  }, [price?.pricehigh, price?.pricelow]);
                ...
                <div className="d-flex align-items-center gap-10">
                  <div className="form-floating">
                    <input
                      ...
                      placeholder="From"
                      onChange={(e) =>
                        setPrice({ ...price, pricelow: e.target.value })
                      }
                    />
                  ...
                  <div className="form-floating">
                    <input
                      ...
                      placeholder="To"
                      onChange={(e) =>
                        setPrice({ ...price, pricehigh: e.target.value })
                      }
                    />
            ...
            <div className="filter-card mb-3">
              ...
              <div>
                <div className="random-products mb-3 d-flex">
                  <div className="w-50">
                    <img
                      src={products[Math.floor(Math.random() * products.length)]?.images[0]?.url}
                      className="img-fluid"
                      alt="watch"
                    />
                  </div>
                  <div className="w-50">
                    ...
                    <ReactStars
                      ...
                      activeColor="#ffd700"
                    />
                    <b>{products[Math.floor(Math.random() * products.length)]?.price}</b>
                  </div>
                </div>
